...
such actions occur in the middle of an atomic block. In order to
deal with such scenarios, it is desirable to have language support for 
commit blocks, as explained in the next section. 
...
The ahutors would like to thank Torvald Riegel from the Transactional Memory Research
