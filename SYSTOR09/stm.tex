...
isolated scientific algorithms (such as STAMP [citation]) . Moreover, it was mostly 
...
and the STM tools used in our work (Section 3), we describe in details the transactification 
process, including the hurdles we have encountered and the means used to overcome them. We 
then study (in Section 4) the performance of the transactified version, showing that the 
Transactified version is competitive to the legacy code in performance. This demonstrates that 
for some applications, the performance penalty of STM may not be as severe as usually assumed, 
and will hence justify the porting to TM with all the benefits it endures. Finally, we 
summarizes (in Section 5) the lesson learned in the transactification process, including 
our wish-list for future STM versions.
...
\begin{figure}
 ...
 \end{center}
 \caption{Transaction Rate, Single host, $s = 1$: Medium locality.
...
\begin{figure}
 ...
 \end{center}
 \caption{Transaction Rate, $s = 0.1$: Low locality.
...
\begin{figure}
 ...
 \end{center}
 \caption{Transaction Rate, $s = 1$: Medium locality.
...
\begin{figure}
 ...
 \end{center}
 \caption{Transaction Rate, $s = 2$: High locality.}
...
\begin{figure}
 ...
 \end{center}
 \caption{Transaction Rate, $s = 1$: Medium locality, a single process.
