...
\begin{figure*}
 ...
 \subfigure[Request throughput]{
  \includegraphics[width=8.5cm, trim=1cm 9.5cm 0 11cm]{transaction-rate-client-server-0dot1.pdf}
  \label{fig:request-throughput-0.1}
 }
 \hfill
 \subfigure[Average response time]{
  \includegraphics[width=8.5cm, trim=1cm 9.5cm 0 11cm]{response-time-client-server-0dot1.pdf}
...
\begin{figure*}
 \centering
 \subfigure[Request throughput]{
  \includegraphics[width=8.5cm, trim=1cm 9.5cm 0 11cm]{transaction-rate-client-server-1.pdf}
  \label{fig:request-throughput-1}
 }
 \hfill
 \subfigure[Average response time]{
  \includegraphics[width=8.5cm, trim=1cm 9.5cm 0 11cm]{response-time-client-server-1.pdf}
...
\begin{figure*}
 \centering
 \subfigure[Request throughput]{
  \includegraphics[width=8.5cm, trim=1cm 9.5cm 0 11cm]{transaction-rate-client-server-2.pdf}
  \label{fig:request-throughput-2}
 }
 \hfill
 \subfigure[Average response time]{
  \includegraphics[width=8.5cm, trim=1cm 9.5cm 0 11cm]{response-time-client-server-2.pdf}
...
\begin{figure*}
 \centering
 \subfigure[Request throughput]{
  \includegraphics[width=8.5cm, trim=1cm 9.5cm 0 11cm]{transaction-rate-single-process.pdf}
  \label{fig:one-process-request-throughput}
 }
 \hfill
 \subfigure[Abort rate]{
  \includegraphics[width=8.5cm, trim=1cm 9.5cm 0 11cm]{abort-rate.pdf}
