...
Most of the transactions we defined contain both read and write access to
shared memory. This is true not only in case of a cache miss, where a new
object is added to the cache, but also in case of a cache hit, where the
